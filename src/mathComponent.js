...
const handleError = (formula, error, inline, oldErrorPosition) => {
  ...
  return (
    <span style={{
      ...
      <MathComponent formula={beforeError} inline={inline} oldErrorPosition={error.position}/>
...
const MathComponent = ({inline, formula, oldErrorPosition}) => {
  ...
  return <Component math={formula} renderError={(error) => handleError(formula, error, inline, oldErrorPosition)}/>
}
